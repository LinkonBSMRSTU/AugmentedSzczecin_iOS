    ...
    func testSavingListOfPoistoDatabase() {
        ...
        let paramsExample: Array<Dictionary<String,AnyObject>> = [
            [
                ...
                "description": "pl_otwarte_zabytki",
                "location": [
                    "latitude": 53.426098,
                    "longitude": 14.554294
                ]
            ...
            for element in paramsExample {
                ...
                if let data = getObjects(predicate) as? [NSManagedObject] {
                    if (data.count == 1) {
                        ...
                        XCTAssertEqual(fetchedObject.valueForKeyPath(ASPOIAttributes.tag.rawValue) as! String, element["description"] as! String, "")
